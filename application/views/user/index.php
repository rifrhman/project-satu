...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/user/') ?>new/style.css">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo me-auto"><img src="<?= base_url('assets/'); ?>/img/logo.png" alt=""></a>

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" id="text-header" href="#hero-new">Home</a></li>
          <li><a class="nav-link scrollto" id="text-header" href="#about-new">About</a></li>
          <li><a class="nav-link scroll-to" id="text-header" href="<?= base_url('news') ?>">News</a></li>
          <li><a class="nav-link scrollto" id="text-header" href="#services">Services</a></li>
          <li><a class="nav-link scrollto" id="text-header" href="#team">Team</a></li>
          <li><a class="nav-link scrollto" id="text-header" href="#contact">Contact</a></li>
        </ul>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero-new" class="d-flex align-items-center">

    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          <h1>PT MUTUALPLUS GLOBAL RESOURCES</h1>
          <h2>Become a Reputable team in People and Organization Development</h2>
          <a href="#about-new" class="btn btn-block scrollto" id="get">Get Started</a>
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="about-new" class="about-new section-bg">
      <div class="container" data-aos="fade-up">

        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-stretch">
            <div class="content" id="text-ab">
              <h3>About Us</h3>
              <p>
                We are people and organization development that provides all the needs of the organization and human
                resources.
                We have clients from various circles and from various needs.
              </p>
          ...
          <div class="col-xl-7 d-flex align-items-stretch">
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" id="icon-about" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-user"></i>
                  <h4>Competent Human Resources</h4>
                  <p>We are commited to being a human service provider with integrity and competence in their field.</p>
                </div>
                <div class="col-md-6 icon-box" id="icon-about" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Psikotest</h4>
                  <p>We provide enterprise equipment for your organization's needs.</p>
                </div>
                <div class="col-md icon-box" id="icon-about" data-aos="fade-up" data-aos-delay="300">
                  <i class="bx bx-hive"></i>
                  <h4>Cross Industry Clients</h4>
                  <p>We have clients from several different industries</p>
                </div>
                <!-- <div class="col-md-6 icon-box" id="icon-about" data-aos="fade-up" data-aos-delay="400">
    ...
    <section id="tabs" class="tabs">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>News</h2>
          <p>More about news in MutualPlus</p>
        </div>
    ...
    <section id="faq" class="faq">
      <div class="container" data-aos="fade-up">
        ...
        <ul class="faq-list accordion" data-aos="fade-up">
          ...
          <li>
            <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq1">Apa itu PT MutualPlus Global Resources
          ...
          <li>
            <a data-bs-toggle="collapse" data-bs-target="#faq2" class="collapsed">Dimana alamat PT MutualPlus Global
              Resources ? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="<?= base_url('assets/user/'); ?>assets/img/team/team-1.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="<?= base_url('assets/user/'); ?>assets/img/team/team-2.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="<?= base_url('assets/user/'); ?>assets/img/team/team-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="<?= base_url('assets/user/'); ?>assets/img/team/team-4.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Contact with us to get more information and more knowledge about what we are doing for the recruitment
            management.</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box" id="text-contact-addr">
                  <a href="https://g.page/pt-mutualplus?share"><i class="bx bx-map"></i></a>

                  <h3>Our Address</h3>
                  <p class="col-lg-8 mx-auto">Sudirman Park, B 15, Jl. K.H. Mas Mansyur No.Kav. 35, RT.12/RW.11, Karet
                    Tengsin,
                    Kecamatan Tanah
                    Abang, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10220</p>
                </div>
              </div>
              <div class="col-md-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            <h3>PT MutualPlus Global Resources<span>.</span></h3>
            <p>
              Sudirman Park, B 15 <br>
              Jl. K.H. Mas Mansyur No.Kav. 35, RT.12/RW.11 <br>
              Karet Tengsin, Kecamatan Tanah Abang<br>
              Kota Jakarta Pusat <br>
              Daerah Khusus Ibukota Jakarta 10220 <br><br>
